...
## Direct mail playbooks

The Direct Mail — Fallback Lead Generation and Persistent Physical Advertising playbooks, both built on DEFERRD, now live in their own dedicated file: `DIRECT_MAIL_PLAYBOOKS.md`.
...
- `DIRECT_MAIL_PLAYBOOKS.md` — the fallback lead-generation and persistent-advertising playbooks built on this fulfillment service.
