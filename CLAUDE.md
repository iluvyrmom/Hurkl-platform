...
HURKL's business-development and public-record research methods are proprietary and are intentionally not documented in this repository. Do not add them, infer them, or expand on founder strategy in code, comments, or docs unless the founder explicitly authorizes it.
